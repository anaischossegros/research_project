...
data_path = Path("C:/Users/anais/Documents/2-Imperial/0-Research-Project/4-NN/Cox-nnet model/data_lung/mrna")
datas = []
datas_id = []
...
#LUAD
metadata_path = Path("C:/Users/anais/Documents/2-Imperial/0-Research-Project/4-NN/Cox-nnet model/data_lung/metadata.cart.2022-07-18.json")
...
for k in range (501,len(metadata)): 
    case = metadata[k]
...
#LUAD
output_path = Path('C:/Users/anais/Documents/2-Imperial/0-Research-Project/4-NN/Cox-nnet model/data_lung/clinical.cart.2022-07-18.tar')
...
output_df_lung= output_df.set_index(['filename'])
# x_df2.to_csv('x_df2_lung.csv')
...
#pancreatic
# data_norm_path = Path("C:/Users/anais/Documents/2-Imperial/0-Research-Project/4-NN/Cox-nnet model/data/normalized_count")
#LUA2
data_norm_path = Path("C:/Users/anais/Documents/2-Imperial/0-Research-Project/4-NN/Cox-nnet model/data_lung/normalized_lung_LUAD.txt")

data_norm_df = pd.read_csv(data_norm_path, sep=" ")
data_norm_df_lung = data_norm_df.transpose()
# data_norm_df_lung = data_norm_df.drop('Unnamed: 0', axis = 0)
